...
# Defaults
APPNAME="vaultwarden"
APPDIR="$HOME/.local/share/srv/docker/vaultwarden"
DATADIR="$HOME/.local/share/srv/docker/vaultwarden/files"
INSTDIR="$HOME/.local/share/dockermgr/vaultwarden"
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/vaultwarden"
REPORAW="$REPO/raw/$REPO_BRANCH"
APPVERSION="$(__appversion "$REPORAW/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# URL to container image [docker pull URL]
HUB_URL="vaultwarden/server:latest"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Directory variables
SERVER_DATA_DIR=""
SERVER_CONFIG_DIR=""
